...
var select$2 = composable("input", (children) => ({
  $el: "select",
  bind: "$attrs",
  attrs: {
    id: "$id",
...
var date_format = function date2({ value }, format) {
  if (format && typeof format === "string") {
    return regexForFormat(format).test(String(value));
  }
  return !isNaN(Date.parse(String(value)));
};
var email2 = function email3({ value }) {
...
var url2 = function url3({ value }, ...stack) {
  try {
    const protocols = stack.length ? stack : ["http:", "https:"];
    const url4 = new URL(String(value));
    return protocols.includes(url4.protocol);
  } catch {
    return false;
  }
};
...
function date3(date4) {
  const dateTime = typeof date4 === "string" ? new Date(Date.parse(date4)) : date4;
...
var validation$q = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `\u064A\u062C\u0628 \u0623\u0646 \u064A\u0643\u0648\u0646 ${sentence(name)} \u0628\u0639\u062F ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `\u064A\u062C\u0628 \u0623\u0646 \u064A\u0643\u0648\u0646 ${sentence(name)} \u0642\u0628\u0644 ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `\u064A\u062C\u0628 \u0623\u0646 \u064A\u0643\u0648\u0646 ${sentence(name)} \u0628\u064A\u0646 ${date3(args[0])} \u0648 ${date3(args[1])}`;
  },
...
var validation$p = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} mus\xED b\xFDt po ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} mus\xED b\xFDt p\u0159ed ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} mus\xED b\xFDt mezi ${date3(args[0])} a ${date3(args[1])}`;
  },
...
var validation$o = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} skal v\xE6re senere end ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} skal v\xE6re f\xF8r ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} skal v\xE6re mellem ${date3(args[0])} og ${date3(args[1])}`;
  },
...
var validation$n = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} muss nach dem ${date3(args[0])} liegen.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} muss vor dem ${date3(args[0])} liegen.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} muss zwischen ${date3(args[0])} und ${date3(args[1])} liegen.`;
  },
...
var validation$m = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} must be after ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} must be before ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} must be between ${date3(args[0])} and ${date3(args[1])}`;
  },
...
var validation$l = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} debe ser posterior a ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} debe ser anterior a ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} debe estar entre ${date3(args[0])} y ${date3(args[1])}`;
  },
...
var validation$k = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} \u0628\u0627\u06CC\u062F \u0628\u0639\u062F \u0627\u0632 \u062A\u0627\u0631\u06CC\u062E ${date3(args[0])} \u0628\u0627\u0634\u062F.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} \u0628\u0627\u06CC\u062F \u0642\u0628\u0644 \u0627\u0632 \u062A\u0627\u0631\u06CC\u062E ${date3(args[0])} \u0628\u0627\u0634\u062F.`;
    }
...
`;
  ...
  date_between({ name, args }) {
    return `${sentence(name)} \u0628\u0627\u06CC\u062F \u0628\u06CC\u0646 ${date3(args[0])} \u0648 ${date3(args[1])} \u0628\u0627\u0634\u062F.`;
  },
...
var validation$j = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} tulee olla ${date3(args[0])} j\xE4lkeen.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} tulee olla ennen: ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} on oltava v\xE4lill\xE4 ${date3(args[0])} - ${date3(args[1])}`;
  },
...
var validation$i = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} doit \xEAtre post\xE9rieure au ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} doit \xEAtre ant\xE9rieure au ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} doit \xEAtre comprise entre ${date3(args[0])} et ${date3(args[1])}`;
  },
...
var validation$h = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} moat nei ${date3(args[0])} w\xEAze.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} moat foar ${date3(args[0])} falle.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} moat tusken ${date3(args[0])} en ${date3(args[1])} lizze`;
  },
...
var validation$g = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} \u05D7\u05D9\u05D9\u05D1 \u05DC\u05D4\u05D9\u05D5\u05EA \u05D0\u05D7\u05E8\u05D9 ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} \u05D7\u05D9\u05D9\u05D1 \u05DC\u05D4\u05D9\u05D5\u05EA \u05DC\u05E4\u05E0\u05D9 ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} \u05D7\u05D9\u05D9\u05D1 \u05DC\u05D4\u05D9\u05D5\u05EA \u05D1\u05D9\u05DF ${date3(args[0])} \u05D5- ${date3(args[1])}`;
  },
...
var validation$f = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} mora biti u periodu poslije ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} mora biti prije ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} mora biti vrijednost izme\u0111u ${date3(args[0])} i ${date3(args[1])}`;
  },
...
var validation$e = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} nilainya harus lebih dari waktu ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} nilainya harus kurang dari waktu ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} harus diantara waktu ${date3(args[0])} dan waktu ${date3(args[1])}`;
  },
...
var validation$d = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `la data ${sentence(name)} deve essere successiva ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `la data ${sentence(name)} deve essere antecedente ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} deve essere tra ${date3(args[0])} e ${date3(args[1])}`;
  },
...
var validation$c = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)}\u306F${date3(args[0])}\u3088\u308A\u5F8C\u306E\u65E5\u4ED8\u3067\u3042\u308B\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059\u3002`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)}\u306F${date3(args[0])}\u3088\u308A\u524D\u306E\u65E5\u4ED8\u3067\u3042\u308B\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059\u3002`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)}\u306F${date3(args[0])}\u3068${date3(args[1])}\u306E\u9593\u306B\u3042\u308B\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059\u3002`;
  },
...
var validation$b = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} ${date3(args[0])} \uC774\uD6C4\uC5EC\uC57C \uD569\uB2C8\uB2E4`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} ${date3(args[0])} \uC774\uC804\uC5EC\uC57C \uD569\uB2C8\uB2E4`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} ${date3(args[0])}\uC5D0\uC11C ${date3(args[1])} \uC0AC\uC774\uC5EC\uC57C \uD569\uB2C8\uB2E4`;
  },
...
var validation$a = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} moet na ${date3(args[0])} zijn.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} moet v\xF3\xF3r ${date3(args[0])} vallen.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} moet tussen ${date3(args[0])} en ${date3(args[1])} liggen`;
  },
...
var validation$9 = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} musi by\u0107 po ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} musi by\u0107 przed ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `Data w polu ${sentence(name)} musi by\u0107 pomi\u0119dzy ${date3(args[0])} i ${date3(args[1])}`;
  },
...
var validation$8 = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} deve ser posterior a ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} deve ser anterior a ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} deve ser entre ${date3(args[0])} e ${date3(args[1])}`;
  },
...
var validation$7 = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} trebuie s\u0103 fie dup\u0103 ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} trebuie s\u0103 precead\u0103 ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} trebuie s\u0103 fie \xEEntre ${date3(args[0])} \u0219i ${date3(args[1])}`;
  },
...
var validation$6 = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `\u0414\u0430\u0442\u0430 ${sentence(name)} \u0434\u043E\u043B\u0436\u043D\u0430 \u0431\u044B\u0442\u044C \u043F\u043E\u0437\u0436\u0435 ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `\u0414\u0430\u0442\u0430 ${sentence(name)} \u0434\u043E\u043B\u0436\u043D\u0430 \u0431\u044B\u0442\u044C \u0440\u0430\u043D\u044C\u0448\u0435 ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `\u0414\u0430\u0442\u0430 ${sentence(name)} \u0434\u043E\u043B\u0436\u043D\u0430 \u0431\u044B\u0442\u044C \u043C\u0435\u0436\u0434\u0443 ${date3(args[0])} \u0438 ${date3(args[1])}`;
  },
...
var validation$5 = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} mora biti po ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} mora biti pred ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} mora biti med ${date3(args[0])} in ${date3(args[1])}`;
  },
...
var validation$4 = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} m\xE5ste vara efter ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} m\xE5ste vara f\xF6re ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} m\xE5ste vara mellan ${date3(args[0])} och ${date3(args[1])}`;
  },
...
var validation$3 = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} \u0E08\u0E30\u0E15\u0E49\u0E2D\u0E07\u0E40\u0E1B\u0E47\u0E19\u0E27\u0E31\u0E19\u0E17\u0E35\u0E48\u0E2B\u0E25\u0E31\u0E07\u0E08\u0E32\u0E01 ${date3(args[0])}`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} \u0E08\u0E30\u0E15\u0E49\u0E2D\u0E07\u0E40\u0E1B\u0E47\u0E19\u0E27\u0E31\u0E19\u0E17\u0E35\u0E48\u0E17\u0E35\u0E48\u0E21\u0E32\u0E01\u0E48\u0E2D\u0E19 ${date3(args[0])}`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} \u0E08\u0E30\u0E15\u0E49\u0E2D\u0E07\u0E40\u0E1B\u0E47\u0E19\u0E27\u0E31\u0E19\u0E17\u0E35\u0E48\u0E23\u0E30\u0E2B\u0E27\u0E48\u0E32\u0E07 ${date3(args[0])} \u0E41\u0E25\u0E30 ${date3(args[1])}`;
  },
...
var validation$2 = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} ${date3(args[0])}'den sonra olmal\u0131d\u0131r.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} ${date3(args[0])} tarihinden \xF6nce olmal\u0131.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)}, ${date3(args[0])} ve ${date3(args[1])} aral\u0131\u011F\u0131nda olmal\u0131.`;
  },
...
var validation$1 = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} ph\u1EA3i sau ${date3(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} ph\u1EA3i tr\u01B0\u1EDBc ${date3(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} ph\u1EA3i \u1EDF gi\u1EEFa kho\u1EA3ng t\u1EEB ${date3(args[0])} \u0111\u1EBFn ${date3(args[1])}.`;
  },
...
var validation = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)}\u5FC5\u987B\u665A\u4E8E${date3(args[0])}`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)}\u5FC5\u987B\u65E9\u4E8E${date3(args[0])}`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)}\u5FC5\u987B\u5728${date3(args[0])}\u548C${date3(args[1])}\u4E4B\u95F4`;
  },
