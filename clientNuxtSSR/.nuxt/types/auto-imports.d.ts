...
declare global {
  ...
  const chatRoomList: typeof import('../../composables/chatRoomList')['default']
  const refreshToken: typeof import('../../composables/refreshToken')['default']
  const login: typeof import('../../composables/login')['default']
